package com.blogbasbas.fortraining.adapter;
...
import com.blogbasbas.fortraining.ui.DetailActivity;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                varIntent.putExtra("FOTO", MyConstant.THUMBNAILS_URL+berita.get(position).getFoto());
